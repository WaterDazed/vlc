...
#define VLC_PARSER_TIMEOUT   5 /* 5 secs */

static const char *
status_to_string(libvlc_media_parsed_status_t status)
{
    switch (status)
    {
        case libvlc_media_parsed_status_none:       return "none";
        case libvlc_media_parsed_status_pending:    return "pending";
        case libvlc_media_parsed_status_failed:     return "failed";
        case libvlc_media_parsed_status_timeout:    return "timeout";
        case libvlc_media_parsed_status_done:       return "done";
...
main(int argc, const char **argv)
{
    ...
    const struct libvlc_parser_cfg cfg = {
        ...
        .timeout = VLC_PARSER_TIMEOUT * 1000,
    };
