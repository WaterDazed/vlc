...
vlc_module_begin ()
    ...
    vlc_set_shortname( N_("WEBVTT decoder"))
    vlc_set_description( N_("WEBVTT subtitles decoder") )
    vlc_set_callbacks( webvtt_OpenDecoder, webvtt_CloseDecoder )
    vlc_set_subcategory( SUBCAT_INPUT_SCODEC )
    vlc_add_submodule()
        vlc_set_shortname( "WEBVTT" )
        vlc_set_description( N_("WEBVTT subtitles parser") )
        vlc_set_capability( "demux", 11 )
        vlc_set_subcategory( SUBCAT_INPUT_DEMUX )
        vlc_set_callbacks( webvtt_OpenDemux, webvtt_CloseDemux )
        vlc_add_shortcut( "webvtt" )
    vlc_add_submodule()
        vlc_set_shortname( "WEBVTT" )
        vlc_set_description( N_("WEBVTT subtitles parser") )
        vlc_set_capability( "demux", 0 )
        vlc_set_subcategory( SUBCAT_INPUT_DEMUX )
        vlc_set_callbacks( webvtt_OpenDemuxStream, webvtt_CloseDemux )
        vlc_add_shortcut( "webvttstream" )
#ifdef ENABLE_SOUT
    vlc_add_submodule()
        vlc_set_description( "WEBVTT text encoder" )
        vlc_set_capability( "spu encoder", 101 )
        vlc_set_subcategory( SUBCAT_INPUT_SCODEC )
        vlc_set_callback( webvtt_OpenEncoder )
    vlc_add_submodule()
        vlc_set_description( N_("Raw WebVTT muxer") )
        vlc_set_capability( "sout mux", 0 )
        vlc_set_subcategory( SUBCAT_SOUT_MUX )
        vlc_add_shortcut( "webvtt", "rawvtt" )
        vlc_set_callbacks( webvtt_OpenMuxer, webvtt_CloseMuxer )
#endif
vlc_module_end ()
