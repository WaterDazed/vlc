...
vlc_module_begin ()
    vlc_set_description( N_("DirectMedia Object decoder") )
    vlc_add_shortcut( "dmo" )
...
#ifdef ENABLE_SOUT
    vlc_add_submodule ()
    vlc_set_description( N_("DirectMedia Object encoder") )
    vlc_add_shortcut( "dmo" )
    vlc_set_capability( "video encoder", 10 )
    vlc_set_callback( EncoderOpenVideo )

    vlc_add_submodule ()
    vlc_set_description( N_("DirectMedia Object encoder") )
    vlc_add_shortcut( "dmo" )
    vlc_set_capability( "audio encoder", 10 )
    vlc_set_callback( EncoderOpenAudio )
#endif
vlc_module_end ()
