...
vlc_module_begin ()
    ...
    vlc_add_submodule ()
    vlc_set_section( N_( "Dump decoder" ), NULL )
    vlc_set_description( N_("Dump decoder") )
    vlc_set_capability( "spu decoder", -1 )
    vlc_set_callbacks( OpenDecoderDump, CloseDecoder )
