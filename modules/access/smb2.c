...
vlc_module_begin()
    vlc_set_shortname("smb2")
    vlc_set_description(N_("SMB2 / SMB3 input"))
    vlc_set_help(N_("Samba (Windows network shares) input via libsmb2"))
    vlc_set_capability("access", 21)
