...
vlc_module_begin ()
    ...
    vlc_set_description( N_( "SRT input" ) )
    ...
    vlc_add_integer( SRT_PARAM_POLL_TIMEOUT, SRT_DEFAULT_POLL_TIMEOUT,
            ...
            NULL )
    vlc_add_integer( SRT_PARAM_LATENCY, SRT_DEFAULT_LATENCY,
            N_( "SRT latency (ms)" ), NULL )
    vlc_add_password( SRT_PARAM_PASSPHRASE, "",
            N_( "Password for stream encryption" ), NULL )
    vlc_add_obsolete_integer( SRT_PARAM_PAYLOAD_SIZE )
    vlc_add_integer( SRT_PARAM_KEY_LENGTH, SRT_DEFAULT_KEY_LENGTH,
