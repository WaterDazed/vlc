...
vlc_module_begin ()
    vlc_set_shortname ( "OGG" )
    vlc_set_description( N_("OGG demuxer" ) )
    vlc_set_subcategory( SUBCAT_INPUT_DEMUX )
    vlc_set_capability( "demux", 50 )
    vlc_set_callbacks( Open, Close )
    vlc_add_shortcut( "ogg" )
    vlc_add_file_extension("oga")
    vlc_add_file_extension("ogg")
    vlc_add_file_extension("ogm")
    vlc_add_file_extension("ogv")
    vlc_add_file_extension("ogx")
    vlc_add_file_extension("opus")
    vlc_add_file_extension("spx")
vlc_module_end ()
