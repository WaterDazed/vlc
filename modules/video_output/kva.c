...
vlc_module_begin ()
    vlc_set_shortname( "KVA" )
    vlc_set_subcategory( SUBCAT_VIDEO_VOUT )
    vlc_add_string( "kva-video-mode", ppsz_kva_video_mode[0], KVA_VIDEO_MODE_TEXT,
                KVA_VIDEO_MODE_LONGTEXT )
        vlc_change_string_list( ppsz_kva_video_mode, ppsz_kva_video_mode_text )
    vlc_add_bool( "kva-fixt23", false, KVA_FIXT23_TEXT, KVA_FIXT23_LONGTEXT )
    vlc_set_description( N_("K Video Acceleration video output") )
    vlc_add_shortcut( "kva" )
