 ...
 */
vlc_module_begin ()
    vlc_set_shortname (N_("X window"))
    vlc_set_description (N_("X11 video window (XCB)"))
    ...
    vlc_set_callback(EmOpen)
    vlc_add_shortcut ("embed-xid")

    vlc_add_string ("x11-display", NULL, DISPLAY_TEXT, DISPLAY_LONGTEXT)
    vlc_add_integer ("drawable-xid", 0, XID_TEXT, XID_LONGTEXT)
        vlc_change_volatile ()
vlc_module_end ()
