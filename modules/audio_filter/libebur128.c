...
vlc_module_begin()
    vlc_set_shortname("EBU R 128")
    vlc_set_description("EBU R128 standard for loudness normalisation")
    vlc_set_subcategory(SUBCAT_AUDIO_AFILTER)
    vlc_add_integer_with_range(CFG_PREFIX "mode", 0, 0, 4, N_("Mode"), NULL)
    vlc_set_capability("audio meter", 0)
