...
vlc_module_begin ()
    ...
    vlc_set_shortname(N_("Videolan.org's addons finder"))
    vlc_add_shortcut(ADDONS_MODULE_SHORTCUT)
    vlc_set_description(N_("addons.videolan.org addons finder"))
    vlc_set_capability("addons finder", 100)
    vlc_set_callbacks(Open, Close)
vlc_add_submodule ()
    vlc_set_subcategory(SUBCAT_ADVANCED_MISC)
    vlc_set_shortname(N_("Videolan.org's single archive addons finder"))
    vlc_add_shortcut(ADDONS_MODULE_SHORTCUT".vlp")
    vlc_set_description(N_("single .vlp archive addons finder"))
    vlc_set_capability("addons finder", 101)
    vlc_set_callback(OpenDesignated)
vlc_module_end ()
