...
vlc_module_begin ()
    vlc_set_shortname( N_("Stats"))
#ifdef ENABLE_SOUT
    vlc_set_description( N_("Stats encoder function") )
    vlc_set_capability( "video encoder", 0 )
    vlc_add_shortcut( "stats" )
    vlc_set_callback( OpenVideoEncoder )

    vlc_add_submodule ()
    vlc_set_description( N_("Stats encoder function") )
    vlc_set_capability( "audio encoder", 0 )
    vlc_add_shortcut( "stats" )
    vlc_set_callback( OpenAudioEncoder )

    vlc_add_submodule ()
#endif
        vlc_set_section( N_( "Stats decoder" ), NULL )
        vlc_set_description( N_("Stats decoder function") )
    ...
    vlc_add_submodule()
        vlc_set_section( N_( "Stats decoder" ), NULL )
        vlc_set_description( N_("Stats decoder function") )
        vlc_set_capability( "spu decoder", 0 )
        vlc_add_shortcut( "stats" )
        vlc_set_callback( OpenDecoder )
    vlc_add_submodule ()
        vlc_set_section( N_( "Stats demux" ), NULL )
        vlc_set_description( N_("Stats demux function") )
