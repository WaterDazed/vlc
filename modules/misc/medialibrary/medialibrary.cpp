...
vlc_module_begin()
    vlc_set_shortname(N_("media library"))
    vlc_set_description(N_( "Organize your media" ))
    vlc_set_subcategory(SUBCAT_ADVANCED_MISC)
    vlc_set_capability("medialibrary", 100)
    vlc_set_callbacks(Open, Close)
    vlc_add_bool( "ml-verbose", false, ML_VERBOSE, nullptr )
vlc_module_end()
