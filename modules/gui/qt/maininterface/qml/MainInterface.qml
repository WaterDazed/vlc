...
Item {
    ...
    function _loadView() {
        ...
        case  MainCtx.PLAYER_MODE:
            ...
            break
        case MainCtx.MEDIALIB_MODE:
        default:
            viewLoader.source = "qrc:///qt/qml/VLC/MainInterface/MainDisplay.qml"
            break
        }
        _currentMode = MainCtx.effectiveMainViewMode
    }
    ...
    Item {
        ...
        Connections {
            ...
            function onEffectiveMainViewModeChanged() {
                root._loadView()
            }
        }
