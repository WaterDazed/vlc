...
public:
    ...
    Q_PROPERTY(QString currentLyricText READ getCurrentLyricText NOTIFY currentLyricTextChanged FINAL)
    Q_PROPERTY(bool hasLyrics READ hasLyrics NOTIFY hasLyricsChanged FINAL)
    Q_PROPERTY(QVariantList syltLyrics READ getSyltLyrics NOTIFY syltLyricsChanged FINAL)
...
public slots:
    ...
    QString getCurrentLyricText() const;
    bool hasLyrics() const;
    QVariantList getSyltLyrics() const;
...
signals:
    ...
    void currentLyricTextChanged( const QString& );
