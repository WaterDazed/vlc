 ...
 */
vlc_module_begin ()
    vlc_set_shortname (N_("Video capture"))
    vlc_set_description (N_("Video capture (Video4Linux)"))
    vlc_set_subcategory (SUBCAT_PLAYLIST_SD)
    vlc_set_capability ("services_discovery", 0)
    vlc_set_callbacks (OpenV4L, Close)
    vlc_add_shortcut ("v4l", "video")
#ifdef HAVE_ALSA
    vlc_add_submodule ()
    vlc_set_shortname (N_("Audio capture"))
    vlc_set_description (N_("Audio capture (ALSA)"))
    vlc_set_subcategory (SUBCAT_PLAYLIST_SD)
    vlc_set_capability ("services_discovery", 0)
    vlc_set_callbacks (OpenALSA, Close)
    vlc_add_shortcut ("alsa", "audio")
#endif
    vlc_add_submodule ()
    ...
    vlc_set_subcategory (SUBCAT_PLAYLIST_SD)
    vlc_set_capability ("services_discovery", 0)
    vlc_set_callbacks (OpenDisc, Close)
