...
QTBASE_COMMON_CONFIG := -DFEATURE_pkg_config=OFF -DINPUT_openssl=no \
	-DFEATURE_dbus=OFF -DFEATURE_zstd=OFF -DFEATURE_androiddeployqt=OFF \
	-DFEATURE_sql=OFF \
...
QTBASE_CONFIG += $(QTBASE_COMMON_CONFIG) \
	...
	-DFEATURE_png=ON -DFEATURE_system_png=ON -DFEATURE_zlib=ON -DFEATURE_system_zlib=ON -DFEATURE_concurrent=ON \
...
QTBASE_NATIVE_CONFIG := $(QTBASE_COMMON_CONFIG) -DQT_BUILD_TESTS=FALSE \
	...
	-DFEATURE_glib=OFF -DFEATURE_icu=OFF -DFEATURE_concurrent=OFF \
