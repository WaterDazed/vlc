 ...
 */
#define LIBVLC_DOWNLOADER_CBS_VER_0 0
#define LIBVLC_DOWNLOADER_CBS_VER_LATEST LIBVLC_DOWNLOADER_CBS_VER_0
     ...
     * available since \ref LIBVLC_DOWNLOADER_CBS_VER_0
     *
...
{
/**
 * Initial version of libvlc_downloader_request_t
 */
#define LIBVLC_DOWNLOADER_REQUEST_VER_0 0
#define LIBVLC_DOWNLOADER_REQUEST_VER_LATEST LIBVLC_DOWNLOADER_REQUEST_VER_0
     ...
     *
     * \note Mandatory (can't be NULL),
     * available since \ref LIBVLC_DOWNLOADER_REQUEST_VER_0
     *
...
{
/**
 * Initial version of struct libvlc_downloader_cfg
 */
#define LIBVLC_DOWNLOADER_CFG_VER_0 0
#define LIBVLC_DOWNLOADER_CFG_VER_LATEST LIBVLC_DOWNLOADER_CFG_VER_0
 ...
 * \param cbs downloader callbacks (must not be NULL)
